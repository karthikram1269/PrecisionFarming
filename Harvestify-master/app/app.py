...
def contact_us():
    title = 'Precision Farming - contact'
    return render_template('Contact.html', title=title)
@app.route('/team_members')
def team_members():
    title='Precision Farming - team'
    return render_template('team.html',title=title)


@app.route('/crop_price')
def crop_price():
    context = {
        "top5": TopFiveWinners(),
    ...
    return render_template('price.html', context=context)
...
def fertilizer_recommendation():
    title = 'Precision Farming - Fertilizer Suggestion'
...
@app.route("/rain_fall", methods=['GET', 'POST'])
def rain_fall():
    if request.method == "POST":
        # DATE
    ...
    title = 'Precision Farming - RainFall Prediction'
...
def disease_prediction():
    title = 'Precision Farming - Disease Detection'
...
# render crop price prediction result page
@ app.route('/price-result', methods=['POST'])
def price_result():
    title = 'Precision Farming - Crop Price Prediction'
    ...
    if request.method == 'POST':
        ...
        predicted_price = 100
        # Ensure that 'your_price_prediction_function' is replaced with the actual function

        return render_template('price-result.html', cropType=crop_type, pricePrediction=predicted_price, title=title)
